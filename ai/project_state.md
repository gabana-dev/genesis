...
- Canon substance — waiting on researcher authorship (not a blocker, a boundary).

## Explicitly empty by design

- `src/`, `tests/` — no implementation until the foundations earn it.
